...
type Instance struct {
	...
	// DiscordConfig is the Discord counterpart of SlackConfig: enabled flag,
	// guild/channel allowlist, and DM policy as JSON, rendered into the
	// agent's OpenClaw `channels.discord` block at boot via the
