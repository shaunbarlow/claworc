...
// 00018_noop_instance_connector_token: registry placeholder for the
// Instance.ConnectorRuntimeToken column added for the managed OpenConnector
// integration (per-agent scoped runtime token, minted against the shared
// connector service and injected as OOMOL_CONNECT_RUNTIME_TOKEN).
//
...
func init() {
	register(&goose.Migration{
		Version: 18,
		Source:  "00018_noop_instance_connector_token.go",
